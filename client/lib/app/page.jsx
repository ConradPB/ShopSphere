        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((product) => (<div key={product.id} className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition">
                <Image src={isValidUrl(product.image_url)
                ? product.image_url
                : FALLBACK_IMAGE} alt={product.name || "Unnamed Product"} width={300} height={192} className="w-full object-cover rounded-md mb-4"/>
