...
const Hero = () => {
  return (
    <section className="relative w-screen min-h-[85vh] flex flex-col justify-center items-center text-center px-6 sm:px-10 py-20 bg-gradient-to-br from-accent-green via-cyan-500 to-blue-600 text-white overflow-hidden">
