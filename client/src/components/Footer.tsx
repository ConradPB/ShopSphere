...
const Footer = () => {
  return (
    <footer
      ...
      // Explicit dark background so it doesn't depend on theme variables
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(11,19,32,0.9), rgba(11,19,32,0))",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="flex space-x-4">
              {[
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-2 rounded-full bg-white/6 hover:bg-white/10 transition-all duration-200 flex items-center justify-center"
                >
        ...
        <div className="mt-10 pt-6 border-t border-white/8 text-center text-sm text-gray-400">
